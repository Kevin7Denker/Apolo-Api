...
class UserController {
    ...
    signUp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.userRepository.signUp(name, surname, email, phone, password);
                res.status(201).json({
                    success: true,
                ...
                res.status(500).json({ success: false, msg: { response: express_1.response }, error });
            }
        });
    }
    signIn(req, res) {
